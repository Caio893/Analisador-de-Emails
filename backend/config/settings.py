...
GMAIL_SYNC_QUERY = env("GMAIL_SYNC_QUERY")
GMAIL_HISTORY_MAX_CHANGES = int(env("GMAIL_HISTORY_MAX_CHANGES", "250"))
GOOGLE_API_TIMEOUT_SECONDS = float(env("GOOGLE_API_TIMEOUT_SECONDS", "15"))
GMAIL_WATCH_TOPIC = env("GMAIL_WATCH_TOPIC")
GMAIL_WATCH_RENEWAL_HOURS = int(env("GMAIL_WATCH_RENEWAL_HOURS", "24"))
...
OPENAI_MAX_OUTPUT_TOKENS = int(env("OPENAI_MAX_OUTPUT_TOKENS", "350"))
OPENAI_BODY_CHAR_LIMIT = int(env("OPENAI_BODY_CHAR_LIMIT", "3000"))
OPENAI_PROMPT_VERSION = env("OPENAI_PROMPT_VERSION", "email-security-v2")
OPENAI_DAILY_ANALYSIS_LIMIT = int(env("OPENAI_DAILY_ANALYSIS_LIMIT", "0"))

VALKEY_HOST = env("VALKEY_HOST", "valkey")
VALKEY_PORT = env("VALKEY_PORT", "6379")
VALKEY_URL = env("VALKEY_URL", f"valkey://{VALKEY_HOST}:{VALKEY_PORT}/0")
ANALYSIS_QUEUE_ENABLED = env_bool("ANALYSIS_QUEUE_ENABLED", False)
ANALYSIS_QUEUE_AUTO_ENQUEUE = env_bool("ANALYSIS_QUEUE_AUTO_ENQUEUE", False)
...
VALKEY_SOCKET_CONNECT_TIMEOUT_SECONDS = float(env("VALKEY_SOCKET_CONNECT_TIMEOUT_SECONDS", "5"))
VALKEY_SOCKET_TIMEOUT_SECONDS = float(env("VALKEY_SOCKET_TIMEOUT_SECONDS", "10"))
